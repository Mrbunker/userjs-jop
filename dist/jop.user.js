...
(function(preact2) {
  ...
  function getCode(cms) {
    ...
    if (!codeNode)
      return "";
    const codeText = cms.name === "javdb" ? codeNode.dataset.clipboardText : codeNode.innerText.replace("复制", "");
  ...
  (w.prototype = new preact2.Component()).isPureReactComponent = true, w.prototype.shouldComponentUpdate = function(n, t2) {
  ...
  preact2.Component.prototype.isReactComponent = {}, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(t2) {
    Object.defineProperty(preact2.Component.prototype, t2, { configurable: true, get: function() {
  ...
  preact2.options.vnode = function(n) {
    ...
    if ("string" == typeof t2) {
      ...
      "select" == t2 && u2.multiple && Array.isArray(u2.value) && (u2.value = preact2.toChildArray(e2.children).forEach(function(n2) {
        n2.props.selected = -1 != u2.value.indexOf(n2.props.value);
      })), "select" == t2 && null != u2.defaultValue && (u2.value = preact2.toChildArray(e2.children).forEach(function(n2) {
  ...
  function serachPageParser(responseText, {
    ...
    if (isSuccess) {
      ...
      const hasSubtitle = titleNodeText.includes("字幕") || titleNodeText.includes("subtitle") || checkResult;
      return {
        isSuccess: true,
  ...
  const App = R(function({
    current,
    CODE
  }) {
    const defDisables = ["AvJoy", "baihuse", "GGJAV", "AV01", "JavBus", "JavDB", "JAVLib"];
    const [dis, setDisState] = p(GM_getValue("disable", defDisables));
    return o(preact2.Fragment, {
      children: [o("div", {
        class: "jop-list",
        children: siteList.map((item) => {
          const hidden = dis.find((disItem) => disItem === item.name) === void 0;
